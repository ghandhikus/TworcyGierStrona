package com.clockwise.tworcy.model.navigation;
...
public @Component("nav") class Navigation {
	...
	public Navigation() {
		...
		// Profiles
		add("profile","/profile/");
		add("profileRemove","/profile/remove/");
		add("removeProfile","/profile/remove/");
		add("profileSpecific","/profile/get/");
		add("specificProfile","/profile/get/");
		add("profileEdit","/profile/edit");
		add("editProfile","/profile/edit");
	}
